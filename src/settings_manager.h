...
public:
    ...
    bool isCustomFontEnabled() const;
    void setCustomFontEnabled(bool enabled);

    QString getCustomFontFamily() const;
    void setCustomFontFamily(const QString &family);

    int getCustomFontSize() const;
    void setCustomFontSize(int sizePoint);
